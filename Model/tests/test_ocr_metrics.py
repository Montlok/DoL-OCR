...
class TestNominalNormalize(unittest.TestCase):
    ...
    def test_removed_backend_fails_explicitly(self):
        with self.assertRaisesRegex(ValueError, "removed"):
            nominal_normalize([MONG], backend="rust")
...
class TestCER(unittest.TestCase):
    ...
    def test_single_backend_decision_on_auto(self):
        ...
        # _fold_pair folds the concatenated batch once, so both sides always use
        # the same deterministic implementation.
