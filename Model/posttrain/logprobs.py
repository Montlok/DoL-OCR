...
"""Per-token log-probability helpers for RL post-training.

Correctness is the whole point here: every policy-gradient objective (GRPO,
PPO) reduces to log-probabilities of realized tokens under a policy and
